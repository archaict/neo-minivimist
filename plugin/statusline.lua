...
function! Modetheme(group)
  ...
  au WinEnter,BufWinEnter,FileType,ColorScheme,SessionLoadPost * hi User5  cterm=None gui=None ctermfg=008 guifg=#DDDDDD guibg=#5E5E9C " VISUAL | VIOLET
  au WinEnter,BufWinEnter,FileType,ColorScheme,SessionLoadPost * hi User6  cterm=None gui=None ctermfg=008 guifg=#303030 guibg=#FF8F40 " INSERT | ORANGE
