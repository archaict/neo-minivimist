" Taken from : https://github.com/ayu-theme/ayu-vim
" Initialisation:"{{{
" ----------------------------------------------------------------------------
hi clear
if exists("syntax_on")
...
let s:palette.fg        = {'dark': "#EEEEEE",  'light': "#5C6773",  'mirage': "#D9D7CE"}
...
exe "hi! TabLine"       .s:fg_bg          .s:bg_panel       .s:fmt_revr
"   TabLineFill"
"   TabLineSel"
